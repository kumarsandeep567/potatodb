...
@section('content')
    <div class="tvshow-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $tvshow['poster_path'] }}" alt="tvPoster" class="w-64 md:w-96 rounded-md">
            </div>
            <div class="md:ml-24">
                <h2 class="text-4xl text-red-600 font-semibold">{{ $tvshow['name'] }}</h2>
                ...
                <div class="mt-12">
                    <h4 class="text-black font-semibold">Created By</h4>
                    <div class="flex mt-4">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                            <iframe 
                                                ...
                                                src="https://www.youtube.com/embed/{{ $tvshow['videos'] }}" 
                                                style="border:0;" 
